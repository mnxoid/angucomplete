...
angular.module('angucomplete', [] )
    ...
    return {
        ...
        scope: {
            "id": "@id",
            "name": "@name",//Name parameter added for usage within <form>
